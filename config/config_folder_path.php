...
define('DIRECTORY_PUBLIC_IMG_LAYOUT_THUMBNAILS', DIRECTORY_PUBLIC_IMG_LAYOUT . DIRECTORY_SEPARATOR . 'thumbnails');
// URLs
...
define('DIRECTORY_PUBLIC_IMG_LAYOUT_THUMBNAILS_URL', DIRECTORY_PUBLIC_IMG_LAYOUT_URL . '/' . 'thumbnails');
