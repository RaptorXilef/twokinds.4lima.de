...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (rejectAllBtn) {
    rejectAllBtn.addEventListener("click", () => {
      if (debugModeJs) console.log("DEBUG: 'Alle ablehnen' Button geklickt.");
      setConsent({
  ...
  document.querySelectorAll(".toggle-details").forEach((toggle) => {
    toggle.addEventListener("click", () => {
      if (debugModeJs) console.log("DEBUG: Toggle-Details geklickt.");
...
function checkConsentAndDisplayBanner() {
  ...
  if (consent === null) {
    ...
    if (debugModeJs) console.log("DEBUG: Consent gefunden:", consent);
...
function showCookieBanner() {
  if (debugModeJs) console.log("DEBUG: showCookieBanner() aufgerufen.");
  const banner = document.getElementById("cookieConsentBanner");
  if (banner) {
...
function hideCookieBanner() {
  if (debugModeJs) console.log("DEBUG: hideCookieBanner() aufgerufen.");
  const banner = document.getElementById("cookieConsentBanner");
  if (banner) {
    banner.style.display = "none";
    if (debugModeJs) console.log("DEBUG: Cookie-Banner ausgeblendet.");
  }
}
 ...
 */
function getConsent() {
  if (debugModeJs) console.log("DEBUG: getConsent() aufgerufen.");
  try {
...
function loadGoogleAnalytics() {
  ...
  if (!window.dataLayer) {
    window.dataLayer = [];
    if (debugModeJs) console.log("DEBUG: window.dataLayer initialisiert.");
  }
  ...
  if (debugModeJs) console.log("DEBUG: GA Skript im DOM gefunden:", !!gaScript);
...
function disableGoogleAnalytics() {
  ...
  if (window.gaConfigured) {
    if (typeof window.gtag === "function") {
      ...
      if (debugModeJs) console.log("DEBUG: Google Analytics deaktiviert.");
    }
