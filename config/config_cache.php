 ...
 * 
 * @file      ROOT/config/config_cache.php
...
// TODO: Funktion in den entsprechenden PHP Dateien verwenden, statt manuell zu laden
...
if (!defined('ENABLE_CACHE_BUSTING')) {
    define('ENABLE_CACHE_BUSTING', false);
}
