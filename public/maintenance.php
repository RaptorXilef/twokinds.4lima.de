...
$logoPath       = $baseUrl . 'assets/images/layout/ui/tkbutton3.webp'; // Fallback auf den TK-Button, den du im SCSS referenziert hast
$localLogoCheck = __DIR__ . '/assets/images/layout/ui/tkbutton3.webp';
...
<head>
    ...
    <style>
        body {
            background: #002b3c; /* TwoKinds Night Theme BG als Fallback */
            display: flex;
            align-items: center;
        ...
        .c-maintenance-card {
            ...
            text-align: center;
            max-width: 500px;
            border-top: 5px solid #00add9; /* TwoKinds Link Color */
...
<body>
    <div class="c-maintenance-card">
        <?php if ($hasLogo) { ?>
            <img src="<?php echo \htmlspecialchars($logoPath); ?>" class="c-logo" alt="Twokinds Logo">
        <?php } ?>
        ...
        <p style="color: #ccc; line-height: 1.6;">
            Wir aktualisieren gerade das System für <br><strong>Twokinds auf Deutsch</strong>,<br> <?php // TODO Name in Config auslagern mit Fallback?>
            um dir das bestmögliche Leseerlebnis zu bieten.
        </p>

        <?php if ($isAdminMaintenance) { ?>
            <div class="status-badge">
                Vollständige Systemwartung (Admin-Modus)
            </div>
        <?php } ?>

        <p style="margin-top: 25px; font-weight: bold; color: #81dbfe;">
            In Kürze sind wir wieder für dich da!
        </p>

        <div style="margin-top: 30px; padding-top: 20px; border-top: 1px dashed #2a6177; font-size: 0.85rem; color: #777;">
