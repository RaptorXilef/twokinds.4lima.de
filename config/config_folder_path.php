...
define('DIRECTORY_PUBLIC_IMG_UI_ICON', DIRECTORY_PUBLIC_IMG_LAYOUT . DIRECTORY_SEPARATOR . 'ui');
...
define('DIRECTORY_PUBLIC_IMG_UI_ICON_URL', DIRECTORY_PUBLIC_IMG_LAYOUT_URL . '/' . 'ui');
